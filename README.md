# sanity-gatsby-design-portfolio
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/7d5qw9am/settings/api) and create a token with read rights.
